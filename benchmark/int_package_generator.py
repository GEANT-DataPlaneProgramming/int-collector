...
if __name__ == "__main__":
    ...
    parser.add_argument("-s", "--send", default=1000, type=int,
    ...
    if args.linear:
        ...
        generator = LinearGenerator(hops = args.hops, log_level = args.log_level, packets_gen = args.gen ,packets_sent= args.send)
